    ...
    romanceFraud: [
      {
        ...
        script: [
          ...
          { character: "character1", text: "這是我很好的廠商給我的私下回扣，我們員工不能領，你能幫我用一下嗎？我明天帶你去喫無菜單料理！" },
          ...
          { character: "character1", text: "你就是不相信我才會在那邊猜測，明天也不用去喫了，就這樣吧..." },
          { character: "character2", text: "好啦我跟我爸借，你不要生氣好不好。" },
          { character: "character1", text: "好啦～就知道寶貝最愛我了！" }
        ],
        tips: "真正愛你的人是不會情緒勒索你的，突然要請你加別人的LINE也要多加註意。"
      },
      {
        ...
        script: [
          ...
          { character: "character1", text: "一次最低五萬元，所以纔想找老婆一起合資，這樣老婆也可以賺到錢！" },
    ...
    shoppingFraud: [
      ...
      },
      {
        ...
        script: [
          ...
          { character: "character2", text: "您好，您是住哪呢？我只接受臺中面交哦。" },
      ...
      },
      {
        ...
        script: [
          ...
          { character: "character2", text: "所以費用是 $4500+$500=$5000 嗎？可以臺北面交嗎？" },
          ...
          { character: "character1", text: "取票序號：36118625，您再到超商機臺取票就可以了。" },
        ],
    ...
    investmentFraud: [
      {
        ...
        script: [
          ...
          { character: "character1", text: "對，希望是用我的名義去投，所以是先借我然後我去簽這樣，我再每個月固定還你，如果現階段沒認，就是醫生喫去這些股份" },
          { character: "character2", text: "我大概懂你的意思了，等於現在需要112萬嗎？" },
          { character: "character1", text: "對，想辦法先喫下來。" },
      ...
      },
      {
        ...
        script: [
          ...
          { character: "character2", text: "那想問有什麼顧問費嗎？看到其他羣組都需要有顧問費。" },
      ...
      {
        background: "你被邀進一個投資羣組，並加了投資助理，想嘗試看看裡面的建議股票。",
        script: [
          ...
          { character: "character1", text: "本次佈局標的：天平道合08577.HK，掛單價位：1.11，買進股數15000，買進資金$60000臺幣。" },
    ...
    imperFraud: [
      ...
      },
      {
        ...
        script: [
          ...
          { character: "character2", text: "好的，可是隻要輸入手機號碼就能歸戶吧。" },
