// 詐騙測驗對話資料 —— 照搬自網站 QuizContext.jsx
// 每個類型 3 個情境;correctIndex 指出「對方開始進行詐騙的關鍵句」在 script 中的索引

export const FRAUD_TYPES = [
  { key: 'romanceFraud', name: '交友戀愛詐騙', desc: '預防虛假感情的陷阱', accent: '#F2873E' },
  { key: 'imperFraud', name: '冒名詐騙', desc: '守護個人身份資料', accent: '#E0A93C' },
  { key: 'shoppingFraud', name: '購物詐騙', desc: '安全網購交易須知', accent: '#5BBF8A' },
  { key: 'investmentFraud', name: '投資詐騙', desc: '警惕不合理的高額利潤回報', accent: '#9A82E0' },
];
